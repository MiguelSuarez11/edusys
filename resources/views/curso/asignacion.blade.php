                            ...
                            <table id="miTabla" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($profesores as $profesor)
                                        <tr>
                                            <td>{{ $profesor->id }}</td>
                                            <td>{{ $profesor->PersonalUser->nombres }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('cursos.asignacionEdit', $profesor) }}">
                                                        <i class="fas fa-sign-in-alt"></i>
                                                    </a>
                                                    <form id="deleteForm-{{ $profesor->id }}" action="" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a type="button" class="btn btn-danger btn-sm deleteButton"
                                                            data-ficha-id="{{ $profesor->id }}"><i
